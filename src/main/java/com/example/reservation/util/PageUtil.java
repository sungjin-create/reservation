...
public class PageUtil {
    ...
    */
    ...
    public PageUtil(long totalCount, long pageSize, long pageIndex, String order) {
    ...
    public String pager() {
        ...
        for(long i = startPage; i<= endPage; i++) {
            if (i == pageIndex) {
                sb.append(String.format("<a class='on' href='?pageIndex=%d%s&order=%s'>%d</a>", i, addQueryString, order,i ));
            } else {
                sb.append(String.format("<a href='?pageIndex=%d%s&order=%s'>%d</a>", i, addQueryString, order, i));
            }
            sb.append(System.lineSeparator());
        }
